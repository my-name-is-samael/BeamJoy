...
return function(ctxt, cache)
    ...
    if cache.showVoteBtn then
        if IconButton("joinSpeed", mgr.voters[BJI_Context.User.playerID] and
                ...
                { disabled = not ctxt.isOwner or cache.disableButtons, big = true,
                    btnStyle = mgr.voters[BJI_Context.User.playerID] and
        ...
        TooltipText(mgr.voters[BJI_Context.User.playerID] and
